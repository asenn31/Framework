...
<a class="btn btn-primary mb-3" href="<?php echo URLROOT; ?>/kost/tambahTransaksi" role="button">Tambah Data</a>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-danger" href="<?php echo URLROOT; ?>/kost/hapusTransaksi/<?php echo $transaksi->id; ?>"  role="button"><i class="fas fa-trash    "></i></a>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
